...
export const COST_EVENTS = [
  ...
  { id: 'evt-107', sessionId: 'sess-access4all-0714', agentRole: 'builder-agent', provider: 'anthropic', model: 'claude-sonnet-5-thinking-high', inputTokens: 6400, outputTokens: 2800, estimatedCostUsd: 0.28, timestamp: '2026-07-14T13:20:00.000Z', date: '2026-07-14', purpose: 'Wheelmap + catalog integration', taskName: 'access4all-integrations', runtimeMs: 6200 },
  ...
  { id: 'evt-081', sessionId: 'sess-access4all-0712', agentRole: 'designer-agent', provider: 'openai', model: 'gpt-4o', inputTokens: 2900, outputTokens: 1100, estimatedCostUsd: 0.12, timestamp: '2026-07-12T10:00:00.000Z', date: '2026-07-12', purpose: 'Travel product design system', taskName: 'accesslink-design', runtimeMs: 3100 },
  ...
  { id: 'evt-072', sessionId: 'sess-access4all-0711', agentRole: 'architect-agent', provider: 'openai', model: 'gpt-4o-mini', inputTokens: 3200, outputTokens: 900, estimatedCostUsd: 0.02, timestamp: '2026-07-11T16:00:00.000Z', date: '2026-07-11', purpose: 'Catalog data model review', taskName: 'catalog-review', runtimeMs: 1900 },
